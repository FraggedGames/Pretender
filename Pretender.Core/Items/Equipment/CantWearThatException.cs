...
{
    public class CantWearThatException : Exception
    {
        public CantWearThatException()
        {
        }

        public CantWearThatException(String message) : base(message)
        {
        }

        public CantWearThatException(String message, Exception innerException) : base(message, innerException)
        {
        }

        protected CantWearThatException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        }
    }
}
